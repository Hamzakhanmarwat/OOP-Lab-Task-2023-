...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->pictureBox1->Size = System::Drawing::Size(966, 127);
			...
			this->pictureBox2->Location = System::Drawing::Point(-1, 124);
			this->pictureBox2->Name = L"pictureBox2";
			this->pictureBox2->Size = System::Drawing::Size(966, 450);
			...
			this->label1->Font = (gcnew System::Drawing::Font(L"Javanese Text", 27.75F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label1->ForeColor = System::Drawing::Color::Snow;
			this->label1->Location = System::Drawing::Point(128, 24);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(294, 84);
			this->label1->TabIndex = 2;
			this->label1->Text = L"Welcome to my";
			...
			this->label2->Font = (gcnew System::Drawing::Font(L"Javanese Text", 27.75F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label2->ForeColor = System::Drawing::SystemColors::HighlightText;
			this->label2->Location = System::Drawing::Point(540, 24);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(329, 84);
			this->label2->TabIndex = 3;
			this->label2->Text = L"First GUI Project";
			...
			this->ClientSize = System::Drawing::Size(964, 573);
